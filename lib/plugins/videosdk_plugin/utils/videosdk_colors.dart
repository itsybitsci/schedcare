...
class VideoSdkColorConstants {
  ...
  static const Color grey = Color.fromRGBO(29, 41, 57, 1);
  static const Color red = Color.fromRGBO(255, 93, 93, 1);
  static const Color purple = Color.fromRGBO(85, 104, 254, 1);
  static const Color textGray = Color.fromRGBO(154, 159, 156, 1);
  static const Color yellow = Color.fromRGBO(250, 167, 19, 1);
